function rho = UNIWARD(image)%cover's type is double
sgm = 1;
...
coverPadded = padarray(image, [padSize padSize], 'symmetric');
...
rho(image==255) = wetCost; % do not embed +1 if the pixel has max value
rho(image==0) = wetCost; % do not embed -1 if the pixel has min value
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
